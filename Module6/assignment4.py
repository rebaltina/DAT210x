...
#
# .. your code here ..
X=pd.read_csv('c:/Users/User/workspace/DAT210x/Module6/Datasets/wheat.data')
...
DecisionTree = tree.DecisionTreeClassifier(max_depth=1,  random_state=2)
...
benchmark(knn, X_train, X_test, y_train, y_test, 'DecisionTree')
drawPlots(knn, X_train, X_test, y_train, y_test, 'DecisionTree')
