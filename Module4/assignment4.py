...
#
# .. your code here ..
Plot2D(T, 'face_data_PCA', 1, 2, num_to_plot=40)
...
Plot2D(manifold, 'face_data_isoMap', 1, 2, num_to_plot=40)
#
...
Plot3D(manifold, 'face_data_isoMap3D', 0, 1, 2, num_to_plot=40)
...
ax.scatter(manifold(), c='r', marker='.')
